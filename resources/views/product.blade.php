                    ...
                    <div class="sidebar__widget widget-collapse-show">
                        ...
                        <div class="sidebar__menu">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('product.filter', $cat->slug) }}" class="{{ (isset($selectedCategory) && $selectedCategory->id == $cat->id) ? 'fw-bold text-primary' : '' }}">
                                ...
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        ...
                                        <div class="grid__wraper__icon">
                                            <ul>
                                                <li>
                                                    <a href="{{ route('cart.add', $data->id) }}" onclick="event.preventDefault(); document.getElementById('add-to-cart-form-{{ $data->id }}').submit();" data-bs-toggle="tooltip" title="Add To Cart">
                    ...
                    <div class="tab-pane fade active show" id="projects__one" role="tabpanel" aria-labelledby="projects__one">
                        <div class="row grid__responsive">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraperimg__inner">
                                            <a href="{{ url('/product/' . $data->slug) }}">
                                    ...
                                    <div class="grid__wraper__info">
                                        ...
                                        <div class="grid__wraper__price">
                                            <span>Rp {{ number__format($data->price, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraperimg__inner">
                                            <a href="{{ url('/product/' . $data->slug) }}">
                                                ...
                                                <img class="secondary__image" src="{{ $secondaryImage }}" alt="{{ $data->name }}">
                                            </a>
                                        </div>
                                    </div>

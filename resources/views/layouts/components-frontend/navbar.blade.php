                                    ...
                                    <ul class="headerarea__submenu headerarea__megamenu">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__1.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__2.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__3.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__4.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__5.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__6.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__7.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid" src="{{asset('assets/frontend/img/collection/collection__8.png')}}" alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
        ...
        <div class="headersearch__active__input">
            <form action="/search" method="get" role="search" style="position: relative;">
                <div class="header__form__search">
                    <input type="search" name="q" value="" placeholder="Search our store" class="input-text" autocomplete="off">

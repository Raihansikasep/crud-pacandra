...
<!-- cart-area -->
<div class="cartarea__sp__bottom__100 sp__top__100">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                                ...
                                <td class="cartarea__product__quantity">
                                    <form action="{{ route('cart.update', $item->id) }}" method="POST">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="qty" value="{{ $item->qty }}" class="form-control-sm" min="1" max="{{ $item->product->stock }}" style="max-width: 70px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="cartarea__shipping__update__wraper">
